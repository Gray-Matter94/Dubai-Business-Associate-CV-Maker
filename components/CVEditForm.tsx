...
export const CVEditForm: React.FC<CVEditFormProps> = ({ initialData, onSave, onCancel }) => {
  ...
  const updateAchievement = (expIndex: number, text: string) => {
     // We allow editing achievements as a block of text for easier editing
  ...
  const addExperience = () => {
    setFormData(prev => ({
      ...prev,
      experience: [
        { role: 'New Role', company: 'Company', location: 'Dubai, UAE', dates: '2023 - Present', achievements: ['Achievement 1'] },
        ...prev.experience
      ]
    }));
  };
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4 animate-in fade-in slide-in-from-top-2">
                    <div>
                        ...
                        <input 
                            ...
                            className="w-full p-2 border rounded focus:ring-1 focus:ring-dubai-gold outline-none"
                        />
                    </div>
                    <div>
        ...
        <div className="border rounded-lg p-4">
            ...
            {expandedSection === 'summary' && (
                <textarea 
                    ...
                    rows={4}
                    className="w-full p-2 border rounded focus:ring-1 focus:ring-dubai-gold outline-none mt-2"
                />
            )}
        </div>
